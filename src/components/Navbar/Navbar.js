...
function Navbar() {
    ...
    return (
        <AppBar position='fixed' style={{backgroundColor:'#FEFEFE',color:'black',borderBottom:'5px solid #9E58D6'}}>
           ...
           <Button component={Link} to='/chat' variant='text'color='inherit' >My Collabs</Button>
           <Button component={Link} to='/chat' variant='text'color='inherit' >Projects</Button>
           <Button component={Link} to='/chat' variant='text'color='inherit' >Create Project</Button>
